...
const questions = [
  ...
  {
    id: "0016",
    question: "בעת נסיעתך לאחור:",
    answers: [
      "מותר להשתמש באדם שיכוון אותך.",
      "אתה חייב להשתמש באדם שיכוון אותך.",
      "אתה חייב להשתמש באדם שיכוון אותך, רק בזמן תאורה.",
      "בדרך רביעינית עליך להשתמש באדם שיכוון אותך."
    ],
    correctAnswer: "אתה חייב להשתמש באדם שיכוון אותך.",
    subject: "חוקי תנועה",
    subSubject: "נסיעה לאחור",
    licenseTypes: ["A", "B", "C1", "C", "D"],
    lang: "he"
  },
  {
  ...
  {
    id: "2001",
    question: "\"משקה אלכוהולי משפיע לרעה על יכולת התגובה של נהג\". נכון או לא?",
    answers: [
      "נכון. אלכוהול הוא סם מדכא.",
      "לא נכון. אלכוהול משפר את מצב הרוח ואת יכולת הנהיגה.",
      "לא נכון. אלכוהול משפיע לטובה.",
      "לא נכון. נהג מרגיש שהוא לא יכול לנהוג כשהוא שיכור."
    ],
    correctAnswer: "נכון. אלכוהול הוא סם מדכא.",
    subject: "נהיגה תחת השפעה",
    subSubject: "אלכוהול",
    licenseTypes: ["B"],
    lang: "he"
  }
